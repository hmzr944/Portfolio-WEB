...
function initialiserAnimationsTextes() {
    const elementsAnime = document.querySelectorAll('.anime-texte, .anime-fade');
    elementsAnime.forEach((el, i) => {
        setTimeout(() => {
